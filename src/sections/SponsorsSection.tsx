...
const SPONSORS: Sponsor[] = [
  { name: 'Volvo',             logo: '/sponsors/Asset 1@4x_r1_c1_processed_by_imagy.png' },
  { name: 'Miscot',            logo: '/sponsors/Asset 1@4x_r1_c2_processed_by_imagy.png' },
  { name: 'BMW',               logo: '/sponsors/Asset 1@4x_r1_c3_processed_by_imagy.png' },
  { name: 'Century',           logo: '/sponsors/Asset 1@4x_r1_c4_processed_by_imagy.png' },
  { name: 'Bosch',             logo: '/sponsors/Asset 1@4x_r1_c5_processed_by_imagy.png' },
  { name: 'Reliance Digital',  logo: '/sponsors/Asset 1@4x_r1_c6_processed_by_imagy.png' },
  { name: 'Westside',          logo: '/sponsors/Asset 1@4x_r2_c1_processed_by_imagy.png' },
  { name: 'Classmate',         logo: '/sponsors/Asset 1@4x_r2_c2_processed_by_imagy.png' },
  { name: 'Vivo',              logo: '/sponsors/Asset 1@4x_r2_c3_processed_by_imagy.png' },
  { name: 'Mercedes-Benz',     logo: '/sponsors/Asset 1@4x_r2_c4_processed_by_imagy.png' },
  { name: 'Triumph',           logo: '/sponsors/Asset 1@4x_r2_c5_processed_by_imagy.png' },
  { name: 'KTM',               logo: '/sponsors/Asset 1@4x_r2_c6_processed_by_imagy.png' },
  { name: 'SFS',               logo: '/sponsors/Asset 1@4x_r3_c1_processed_by_imagy.png' },
  { name: 'Royal R',           logo: '/sponsors/Asset 1@4x_r3_c2_processed_by_imagy.png' },
  { name: 'Black Bird',        logo: '/sponsors/Asset 1@4x_r3_c3_processed_by_imagy.png' },
  { name: 'Milano Ice Cream',  logo: '/sponsors/Asset 1@4x_r3_c4_processed_by_imagy.png' },
  { name: 'Accenture',         logo: '/sponsors/Asset 1@4x_r3_c5_processed_by_imagy.png' },
  { name: 'Ultraviolette',     logo: '/sponsors/Asset 1@4x_r3_c6_processed_by_imagy.png' },
  { name: 'Nandini',           logo: '/sponsors/Asset 1@4x_r4_c1_processed_by_imagy.png' },
  { name: 'Pantaloons',        logo: '/sponsors/Asset 1@4x_r4_c2_processed_by_imagy.png' },
  { name: 'Croma',             logo: '/sponsors/Asset 1@4x_r4_c3_processed_by_imagy.png' },
  { name: 'Insights IAS',      logo: '/sponsors/Asset 1@4x_r4_c4_processed_by_imagy.png' },
  { name: 'Pai International', logo: '/sponsors/Asset 1@4x_r4_c5_processed_by_imagy.png' },
  { name: 'Poorvika',          logo: '/sponsors/Asset 1@4x_r4_c6_processed_by_imagy.png' },
]
