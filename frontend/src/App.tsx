...
const App: React.FC = () => {
  ...
  return (
    <>
      {/* FIXED BACKGROUND: Sibling to main to ensure it stays pinned globally */}
      ...
      <main className="w-full min-h-screen relative text-fest-text selection:bg-fest-accent selection:text-fest-bg overflow-x-hidden bg-transparent">
        ...
        >
          {/* BACK BUTTON (Styled like UT.2025) */}
          <button 
            onClick={toggleMenu}
          ...
          {/* Menu Items (Styled like UT.2025) */}
        ...
        {/* The Immersive Hero Section - Only triggers animation after intro is gone */}
        <HeroSection isMobile={isMobile} startAnimation={!showIntro} />

        {/* Content Placeholder (To demonstrate scrolling) */}
        {/* BLURRED: Added backdrop blur and semi-transparent background as requested */}
